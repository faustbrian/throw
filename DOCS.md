...
3. [HTTP Responses](#doc-docs-http-responses)
4. [Integration Patterns](#doc-docs-integration-patterns)
5. [Assertions](#doc-docs-assertions)
6. [Attempt Monad](#doc-docs-attempt-monad)
7. [Base Exceptions](#doc-docs-base-exceptions)
8. [Deferred Cleanup](#doc-docs-deferred-cleanup)
9. [Error Comparison](#doc-docs-error-comparison)
10. [Error Context](#doc-docs-error-context)
11. [Error Wrapping](#doc-docs-error-wrapping)
12. [Exception Filtering](#doc-docs-exception-filtering)
13. [Exception Groups](#doc-docs-exception-groups)
14. [Exception Notes](#doc-docs-exception-notes)
15. [Exception Transformation](#doc-docs-exception-transformation)
16. [Result Integration](#doc-docs-result-integration)
