...
describe('TestDomainException (extends RuntimeException)', function (): void {
    test('can be instantiated', function (): void {
        $exception = TestDomainException::withMessage('Business error');

        expect($exception)
            ->toBeInstanceOf(TestDomainException::class)
...
describe('TestInfrastructureException (extends RuntimeException)', function (): void {
    test('can be instantiated', function (): void {
        $exception = TestInfrastructureException::withMessage('Infrastructure error');

        expect($exception)
            ->toBeInstanceOf(TestInfrastructureException::class)
            ->toBeInstanceOf(RuntimeException::class);
    });
...
describe('TestValidationException (extends InvalidArgumentException)', function (): void {
    test('can be instantiated', function (): void {
        $exception = TestValidationException::withMessage('Validation error');

        expect($exception)
            ->toBeInstanceOf(TestValidationException::class)
