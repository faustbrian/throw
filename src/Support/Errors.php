 ...
 * this class helps you work with exception chains without manually traversing
 * the getPrevious() chain.
 *
 * Both methods (is() and as()) traverse the entire exception chain by following
 * the previous exception links, making it easy to identify and extract specific
 * exception types even when they're deeply wrapped.
 *
 * This is particularly useful when working with exception wrapping patterns where
 * domain exceptions wrap lower-level exceptions (e.g., DatabaseException wrapping
 * PDOException, or ServiceException wrapping HttpException).
 *
