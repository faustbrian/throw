...
trait WrapsErrors
{
    ...
    public function wrap(Throwable $exception): static
    {
        ...
        /**
         * Create new instance with wrapped exception as previous
         *
         * @phpstan-ignore new.static (Required for abstract exception classes)
         */
        $new = new static($this->getMessage(), (int) $this->getCode(), $exception);
